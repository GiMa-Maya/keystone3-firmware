...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"connect_bitget_link", "https://keyst.one/t/3rd/bitgetwallet"},
    {"connect_bitget_title", "Bitget Wallet"},
    ...
    {"derivation_path_ada_ledger_desc", "Used by Ledger and BitBox02. Accounts eg."},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"derivation_path_ada_ledger_desc", "Von Ledger und BitBox02 verwendet. Konten z.B."},
    ...
    {"derivation_path_select_ada", "Wählen Sie die Adressgenerierung, die Sie für Cardano verwenden möchten"},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"derivation_path_ada_ledger_desc", "Usado por Ledger y BitBox02. Cuentas, por ejemplo."},
    ...
    {"derivation_path_select_ada", "Seleccione la generación de direcciones que le gustaría usar para Cardano"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"derivation_path_ada_ledger_desc", "LedgerおよびBitBox02で使用されます。アカウントなど。"},
    ...
    {"derivation_path_select_ada", "カルダノ用に使用するアドレス生成を選択してください"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"derivation_path_ada_ledger_desc", "Ledger와 BitBox02에서 사용됩니다. 예를 들어 계정 등."},
    ...
    {"derivation_path_select_ada", "Cardano에 사용할 주소 생성 방식을 선택하세요."},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"derivation_path_ada_ledger_desc", "Используется Ledger и BitBox02. Например, аккаунты."},
    ...
    {"derivation_path_select_ada", "Выберите метод генерации адреса, который вы хотели бы использовать для Cardano"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"derivation_path_ada_ledger_desc", "由 Ledger 和 BitBox02 使用。例如账户。"},
