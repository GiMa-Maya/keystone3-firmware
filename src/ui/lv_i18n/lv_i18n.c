...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"ada_proposals_tx_notice", "Please note, you are currently signing a transaction related to a voting proposal."},
    ...
    {"connect_helium_link", "https://keyst.one/t/3rd/helium"},
    {"connect_helium_title", "Helium"},
    ...
    {"connect_keystone_title", "Keystone"},
    ...
    {"connect_thorwallet_link", "https://keyst.one/t/3rd/thorwallet"},
    {"connect_thorwallet_title", "THORWallet"},
    ...
    {"connect_xbull_link", "https://keyst.one/t/3rd/xbull"},
    {"connect_xbull_title", "xBull"},
    ...
    {"derivation_path_select_ada", "Select the address generation you’d like to use for Cardano"},
    ...
    {"hardware_call_approve_notice", "Please note, if the path not saved on the device will require a password to be recalculated."},
    ...
    {"invaild_account_path", "Invalid Account Path"},
    {"invaild_account_path_notice", "Please re-enter the path in the software wallet and try again."},
    ...
    {"nft_screen_saver", "NFT Screensaver"},
    {"nft_screen_saver_desc", "Once set successfully, your lock screen will display the selected NFT"},
    {"nft_screen_saver_title", "Set NFT as Home Screen"},
    {"nft_screen_set_title", "How to set up NFT screensaver?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"not_now", "Not Now"},
    ...
    {"receive_ada_more_t_standard", "Icarus"},
    ...
    {"scan_qr_code_signing_hash_signing_desc", "Hash signing uses a private key to sign a transaction's hash for integrity and authenticity. You can compare this with the software wallet."},
    {"scan_qr_code_signing_notice", "Notice"},
    {"scan_qr_code_signing_xdr_signing_desc", "XDR (External Data Representation) standardizes data encoding for consistent serialization. You can compare this with the software wallet."},
    ...
    {"solana_ata_desc", "The account receiving funds. An Associated Token Account (ATA) on Solana. Each user has one ATA per token type, and tokens are sent to the destination ATA."},
    {"solana_auth_account", "The account with transaction authority."},
    {"solana_parse_tx_notice", "The accounts in Instructions will be affected by this transaction. Please review carefully."},
    {"solana_source_ata", "The account sending funds."},
    {"solana_squads_amount_brief", "The amount consists of three parts, you can see it in “Details”."},
    {"solana_squads_amount_desc", "This amount consists of 0.05 SOL one-time platform fee,0.001 SOL which will be deposited into your Squads account and  network rent needed for account deployment."},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms "},
    {"account_head", "Konto"},
    {"ada_proposals_tx_notice", "Bitte beachten Sie, dass Sie derzeit eine Transaktion unterschreiben, die mit einem Abstimmungsvorschlag zusammenhängt."},
    {"ar_address_check", "Kontenprüfung erforderlich"},
    {"ar_address_check_desc", "Unterschiedliche Wallets können AR-Adressen unterschiedlich generieren, was zu unterschiedlichen Adressen aus demselben Satz führt. Dies ist normal. Nach dem Verbinden mit der Software-Wallet vergleichen Sie bitte die Adresse, um sicherzustellen, dass sie mit der Hardware Wallet übereinstimmt"},
    ...
    {"derivation_path_select_ada", "Adressgenerierung für Cardano auswählen"},
    ...
    {"hardware_call_approve_notice", "Bitte beachten Sie, dass wenn der Pfad nicht auf dem Gerät gespeichert ist, ein Passwort neu berechnet werden muss."},
    ...
    {"invaild_account_path", "Ungültiger Kontopfad"},
    {"invaild_account_path_notice", "Bitte geben Sie den Pfad im Software-Wallet erneut ein und versuchen Sie es wieder."},
    ...
    {"nft_screen_saver", "NFT Bildschirmschoner"},
    {"nft_screen_saver_desc", "Una vez configurado correctamente, tu pantalla de bloqueo mostrará el NFT seleccionado"},
    {"nft_screen_saver_title", "NFT als Startbildschirm festlegen"},
    {"nft_screen_set_title", "Wie richtet man einen NFT-Bildschirmschoner ein?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"not_now", "Nicht jetzt"},
    ...
    {"scan_qr_code_signing_hash_signing_desc", "Hash-Signieren verwendet einen privaten Schlüssel, um den Transaktionshash zu signieren, was Integrität und Echtheit gewährleistet. Vergleichbar mit der Software-Wallet."},
    {"scan_qr_code_signing_notice", "Benachrichtigung"},
    {"scan_qr_code_signing_xdr_signing_desc", "XDR (Externe Datenrepräsentation) standardisiert die Datenkodierung für konsistente Serialisierung. Vergleichbar mit der Software-Wallet."},
    {"sdcard_format_confirm", "Format"},
    ...
    {"solana_ata_desc", "Das Konto, das Geld empfängt. Ein zugeordnetes Token-Konto (ATA) auf Solana. Jeder Benutzer hat ein ATA pro Token-Typ, und Tokens werden an das Ziel-ATA gesendet."},
    {"solana_auth_account", "Das Konto mit Transaktionsberechtigung wird in der Solana-Blockchain als Autorisierungskonto (Auth Account) bezeichnet."},
    ...
    {"solana_source_ata", "Das Konto, das Geld sendet, wird in der Solana-Blockchain als Quellkonto (Source Account) bezeichnet."},
    {"solana_squads_amount_brief", "Der Betrag besteht aus drei Teilen, die Sie unter \"Details\" einsehen können."},
    {"solana_squads_amount_desc", "Dieser Betrag setzt sich zusammen aus einer einmaligen Plattformgebühr von 0,05 SOL, 0,001 SOL, die auf Ihr Squads-Konto eingezahlt werden, und der für die Kontobereitstellung erforderlichen Netzwerkmiete."},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "Cuenta"},
    {"ada_proposals_tx_notice", "Tenga en cuenta que actualmente está firmando una transacción relacionada con una propuesta de votación."},
    {"ar_address_check", "Se necesita verificar la cuenta"},
    {"ar_address_check_desc", "Diferentes monederos pueden generar direcciones AR de manera diferente, resultando en direcciones diferentes a partir de la misma frase. Esto es normal. Después de conectarse al monedero de software, por favor compare la dirección para asegurarse de que coincide con el monedero de hardware."},
    ...
    {"derivation_path_select_ada", "Seleccione generación de direcciones para Cardano"},
    ...
    {"hardware_call_approve_notice", "Tenga en cuenta que, si la ruta no se guarda en el dispositivo, se requerirá recalcular la contraseña."},
    ...
    {"invaild_account_path", "Ruta de cuenta no válida"},
    {"invaild_account_path_notice", "Vuelva a ingresar la ruta en la billetera de software e inténtelo de nuevo."},
    ...
    {"nft_screen_saver", "Salvapantallas NFT"},
    {"nft_screen_saver_desc", "一旦设置成功，您的锁屏将显示所选的 NFT"},
    {"nft_screen_saver_title", "Establecer NFT como pantalla de inicio"},
    {"nft_screen_set_title", "¿Cómo configurar el protector de pantalla NFT?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"not_now", "Ahora no"},
    ...
    {"scan_qr_code_signing_hash_signing_desc", "La firma de hash utiliza una clave privada para firmar el hash de la transacción, garantizando integridad y autenticidad. Comparar con la cartera software."},
    {"scan_qr_code_signing_notice", "Aviso"},
    {"scan_qr_code_signing_xdr_signing_desc", "XDR (Representación de Datos Externos) estandariza la codificación de datos para una serialización consistente. Compárelo con la cartera de software."},
    ...
    {"solana_ata_desc", "La cuenta que recibe los fondos. Una Cuenta de Token Asociada (ATA) en Solana. Cada usuario tiene una ATA por tipo de token, y los tokens se envían a la ATA de destino."},
    {"solana_auth_account", "La cuenta con autoridad de transacción se conoce como cuenta de autorización (auth account) en la blockchain de Solana."},
    ...
    {"solana_source_ata", "La cuenta que envía los fondos se conoce como cuenta de origen (source account) en la blockchain de Solana."},
    {"solana_squads_amount_brief", "El monto consta de tres partes, puedes verlo en \"Detalles\"."},
    {"solana_squads_amount_desc", "Este monto consiste en una tarifa única de la plataforma de 0.05 SOL, 0.001 SOL que serán depositados en su cuenta de Squads y el alquiler de red necesario para el despliegue de la cuenta."},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "アカウント"},
    {"ada_proposals_tx_notice", "投票提案に関連するトランザクションに現在署名していることに注意してください。"},
    {"ar_address_check", "アカウントのチェックが必要です"},
    {"ar_address_check_desc", "異なるウォレットは、同じフレーズから異なるアドレスを生成する場合があります。これは正常な動作です。ソフトウェアウォレットに接続後、アドレスがハードウェアウォレットと一致するかどうか確認してください。"},
    ...
    {"derivation_path_select_ada", "Cardanoのアドレス生成方式を選択してください"},
    ...
    {"hardware_call_approve_notice", "注意事項: デバイスにパスが保存されていない場合、パスワードを再計算する必要があります。"},
    ...
    {"invaild_account_path", "無効なアカウントパス"},
    {"invaild_account_path_notice", "ソフトウェアウォレットでパスを再入力してもう一度試してください。"},
    ...
    {"nft_screen_saver", "NFT スクリーンセーバー"},
    {"nft_screen_saver_desc", "Einmal erfolgreich eingestellt, wird Ihr Sperrbildschirm das ausgewählte NFT anzeigen"},
    {"nft_screen_saver_title", "NFTをホーム画面に設定する"},
    {"nft_screen_set_title", "NFTスクリーンセーバーの設定方法は?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"not_now", "今はない"},
    ...
    {"scan_qr_code_signing_hash_signing_desc", "ハッシュ署名は取引のハッシュを秘密鍵で署名し、完全性と真実性を保証します。ソフトウェアウォレットと比較してください。"},
    {"scan_qr_code_signing_notice", "お知らせ"},
    {"scan_qr_code_signing_xdr_signing_desc", "XDR（外部データ表現）はデータのエンコーディングを標準化し、一貫したシリアル化を実現します。ソフトウェアウォレットと比較してください。"},
    ...
    {"solana_ata_desc", "資金を受け取るアカウント。Solanaのアソシエイテッド・トークン・アカウント（ATA）。ユーザーはトークンタイプごとに1つのATAを持ち、トークンは宛先のATAに送信されます。"},
    {"solana_auth_account", "トランザクションの権限を持つアカウントは、Solanaブロックチェーンでは認証アカウント（auth account）と呼ばれています。"},
    {"solana_parse_tx_notice", "指示書の口座がこの取引の影響を受けます。慎重に確認してください。"},
    {"solana_source_ata", "資金を送信するアカウントは、Solanaブロックチェーンではソースアカウント（source account）と呼ばれています。"},
    {"solana_squads_amount_brief", "金額は3つの部分で構成されており、\"詳細\"でご確認いただけます。"},
    {"solana_squads_amount_desc", "この金額は、0.05 SOLの1回限りのプラットフォーム手数料、Squadsアカウントに預け入れられる0.001 SOL、およびアカウントのデプロイメントに必要なネットワークレンタル料で構成されています。"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "계정 전환"},
    {"ada_proposals_tx_notice", "현재 투표 제안과 관련된 거래에 서명하고 있습니다."},
    {"ar_address_check", " 계정 확인 필요"},
    {"ar_address_check_desc", "서로 다른 지갑은 AR 주소를 다르게 생성할 수 있으며, 결과적으로 동일한 구문에서도 다른 주소가 생성될 수 있습니다. 이는 정상적인 현상입니다. 소프트웨어 지갑에 연결한 후 주소가 하드웨어 지갑과 일치하는지 확인해주시기 바랍니다"},
    ...
    {"derivation_path_select_ada", "Cardano 주소 생성 방식 선택"},
    ...
    {"invaild_account_path", "잘못된 계정 경로"},
    {"invaild_account_path_notice", "소프트웨어 지갑에 경로를 다시 입력하고 다시 시도하십시오."},
    {"language_desc", "언어 선택"},
    ...
    {"nft_screen_saver", "NFT 스크린세이버"},
    {"nft_screen_saver_desc", "성공적으로 설정되면"},
    {"nft_screen_saver_title", "NFT를 홈 화면으로 설정하다"},
    {"nft_screen_set_title", "NFT 화면 보호기를 설정하는 방법은?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"not_now", "지금 안함"},
    ...
    {"scan_qr_code_signing_hash_signing_desc", "해시 서명은 거래의 해시를 개인키로 서명하여 무결성과 진위를 보증합니다. 소프트웨어 지갑과 비교하세요."},
    {"scan_qr_code_signing_notice", "알림"},
    {"scan_qr_code_signing_xdr_signing_desc", "XDR(외부 데이터 표현)은 일관된 직렬화를 위해 데이터 인코딩을 표준화합니다. 소프트웨어 지갑과 비교하세요."},
    ...
    {"solana_ata_desc", "자금을 받는 계정. Solana의 연계 토큰 계정(ATA). 각 사용자는 토큰 유형당 하나의 ATA를 가지며, 토큰은 대상 ATA로 전송됩니다."},
    {"solana_auth_account", "트랜잭션 권한을 가진 계정을 Solana 블록체인에서는 인증 계정(auth account)이라고 합니다."},
    {"solana_parse_tx_notice", "지침서에 명시된 계좌들은 이 거래의 영향을 받게 됩니다. 주의 깊게 검토해 주시기 바랍니다."},
    {"solana_source_ata", "자금을 보내는 계정을 Solana 블록체인에서는 소스 계정(source account)이라고 합니다."},
    {"solana_squads_amount_brief", "금액은 세 부분으로 구성되며, \"상세 정보\"에서 확인하실 수 있습니다."},
    {"solana_squads_amount_desc", "이 금액은 0.05 SOL의 일회성 플랫폼 수수료, 귀하의 Squads 계정에 예치될 0.001 SOL, 그리고 계정 배포에 필요한 네트워크 임대료로 구성됩니다."},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "Счет"},
    {"ada_proposals_tx_notice", "Обратите внимание, вы сейчас подписываете транзакцию, связанную с предложением по голосованию."},
    {"ar_address_check", "Требуется проверка аккаунта"},
    {"ar_address_check_desc", "Разные кошельки могут генерировать AR-адреса по-разному, что приводит к различным адресам от одной и той же фразы. Это нормально. После подключения к программному кошельку, пожалуйста, сравните адрес, чтобы убедиться, что он совпадает с адресом аппаратного кошелька."},
    ...
    {"derivation_path_select_ada", "Выберите способ создания адреса для Cardano"},
    ...
    {"hardware_call_approve_notice", "Обратите внимание, что если путь не сохранен на устройстве, потребуется пересчитать пароль."},
    ...
    {"invaild_account_path", "Недействительный путь учетной записи"},
    ...
    {"nft_screen_saver", "NFT Заставка"},
    {"nft_screen_saver_desc", "После успешной установки выбранный NFT будет отображаться на экране блокировки."},
    {"nft_screen_saver_title", "Установить NFT как домашний экран"},
    {"nft_screen_set_title", "Как настроить заставку NFT?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"not_now", "Не сейчас"},
    ...
    {"scan_qr_code_signing_hash_signing_desc", "Хеш-подписание использует приватный ключ для подписи хеша транзакции, обеспечивая её целостность и подлинность. Сравните с программным кошельком."},
    {"scan_qr_code_signing_notice", "Уведомление"},
    {"scan_qr_code_signing_xdr_signing_desc", "XDR (Внешнее представление данных) стандартизирует кодирование данных для последовательной сериализации. Сравните это с программным кошельком."},
    ...
    {"solana_ata_desc", "Счет, получающий средства. Ассоциированный токеновый счет (ATA) на Solana. Каждый пользователь имеет один ATA на каждый тип токена, и токены отправляются на целевой ATA."},
    {"solana_auth_account", "Аккаунт, обладающий полномочиями на проведение транзакций, называется аутентифицирующим аккаунтом (auth account) в блокчейне Solana."},
    {"solana_parse_tx_notice", "Счета, указанные в Инструкциях, будут затронуты этой операцией. Пожалуйста, внимательно проверьте."},
    {"solana_source_ata", "Счет, отправляющий средства, называется исходным счетом (source account) в блокчейне Solana."},
    {"solana_squads_amount_brief", "Сумма состоит из трех частей, которые вы можете увидеть в разделе \"Детали\"."},
    {"solana_squads_amount_desc", "Эта сумма состоит из единовременной платформенной комиссии в размере 0.05 SOL, 0.001 SOL, которые будут зачислены на ваш аккаунт Squads, и арендной платы за сеть, необходимой для развертывания аккаунта."},
    ...
    {"tutorial_ton_mnemonic_title", "Что такое мнемоническая фраза для TON?"},
    {"tutorial_ton_mnemonic_url", "https://keyst.one/t/3rd/ton"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "账户"},
    {"ada_proposals_tx_notice", "请注意，您目前正在签署与投票提案相关的交易。"},
    ...
    {"derivation_path_select_ada", "选择您希望用于 Cardano 的地址生成方式"},
    ...
    {"got_it_fmt", "知道了(%d)"},
    {"got_it_start", "知道了(5)"},
    {"hardware_call_approve_notice", "请注意,如果路径未保存在设备上,将需要重新计算密码。"},
    ...
    {"invaild_account_path", "无效的账户路径"},
    {"invaild_account_path_notice", "请在软件钱包中重新输入路径并重试。"},
    ...
    {"nft_screen_saver", "NFT 屏保"},
    {"nft_screen_saver_desc", " 잠금 화면에 선택한 NFT가 표시됩니다"},
    {"nft_screen_saver_title", "将 NFT 设置为首页"},
    {"nft_screen_set_title", "如何设置 NFT 屏幕保护程序?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"not_now", "稍后"},
    ...
    {"scan_qr_code_signing_hash_signing_desc", "哈希签名利用私钥为交易哈希签名，确保其完整性和真实性。可与软件钱包比较。"},
    {"scan_qr_code_signing_notice", "提示"},
    {"scan_qr_code_signing_xdr_signing_desc", "XDR（外部数据表示）标准化数据编码以实现一致的序列化。可以与软件钱包进行比较。"},
    ...
    {"solana_ata_desc", "Solana上的关联代币帐户(ATA)。每个用户对每种代币类型都有一个ATA,代币被发送到目标ATA。"},
    {"solana_auth_account", "拥有交易权限的账户在 Solana 区块链中被称为授权账户（auth account）。"},
    {"solana_parse_tx_notice", "说明中的账户将受到此交易的影响。请仔细检查。"},
    {"solana_source_ata", "发送资金的账户在 Solana 区块链中被称为源账户（source account）。"},
    {"solana_squads_amount_brief", "该金额由三部分组成，您可以在\"详情\"中查看。"},
    {"solana_squads_amount_desc", "这个金额包括0.05 SOL的一次性平台费用，0.001 SOL将存入您的Squads账户，以及部署账户所需的网络租金。"},
